...
import 'package:user/collection.dart';
import 'package:user/sameScreen.dart';
          ...
          child: Stack(
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(child: Text("Lemon khukuri")),
                      )
                    ],
                  ),
                ),
              ...
              Padding(
                  ...
                  padding: EdgeInsets.fromLTRB(420, 200, 8, 16))
            ],
          ),
        ),
      ),
